...
<exp> es el numero de arichivo seguido por el tipo de grafo (nc para los justos y c para los completos), 
ya que vamos a tener varios con el mismo nombre y asi diferenciarlos entre si

En la carpeta 1 porciento se encuentran los archivos necesarios para reeplicar el experimento que se 
